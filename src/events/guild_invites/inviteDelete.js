      ...
      .setDescription(
        `**Invitation supprimé par ${
          invite.inviterId === null
            ...
            > **Code :** \`${invite.code}\`
            ${
              invite.createdTimestamp === null
                ? ``
                : `> **Crée le :** <t:${parseInt(
                    invite.createdTimestamp / 1000
                  )}:f> <t:${parseInt(invite.createdTimestamp / 1000)}:R>\n`
            } > **A invité :** \`${
          invite.memberCount === null ? `0` : `${invite.memberCount}`
        }\` utilisateurs
            `
      )
      .setTimestamp()
