  ...
  async execute(role) {
    ...
    const embed = new EmbedBuilder()
      ...
      .addFields([
        ...
        },
        {
          ...
          value: setGeneralsPermissions(),
          inline: false,
        },
        {
          name: `Permissions des membres`,
          value: setMemberPermissions(),
          inline: false,
        },
        {
          name: `Permissions de salon textuel`,
          value: setTextuelPermissions(),
          inline: false,
        },
        {
          name: `Permissions de salon vocal`,
          value: setVocalPermissions(),
          inline: false,
        },
        {
        ...
        },
        {
          ...
          value: `${
            permissions.has(PermissionsBitField.Flags.ManageEvents)
    ...
    function setGeneralsPermissions() {
      const field3 = `${
        ...
        permissions.has(PermissionsBitField.Flags.ManageEmojisAndStickers)
          ? `✅ ▸ Gérer les emojis et les autocollants\n`
          : ``
      } ${
        permissions.has(PermissionsBitField.Flags.ViewAuditLog)
          ? `✅ ▸ Voir les logs du serveur\n`
          : ``
      } ${
        permissions.has(PermissionsBitField.Flags.ViewGuildInsights)
    ...
    function setMemberPermissions() {
      const field4 = `${
        ...
        permissions.has(PermissionsBitField.Flags.ChangeNickname)
          ? `✅ ▸ Changer le speudo\n`
          : ``
      } ${
    ...
    function setTextuelPermissions() {
      const field5 = `${
        ...
        permissions.has(PermissionsBitField.Flags.UseExternalStickers)
        ...
        permissions.has(PermissionsBitField.Flags.SendTTSMessages)
          ? `✅ ▸ Envoyer des messages de synthèse vocal\n`
          : ``
      } ${
        permissions.has(PermissionsBitField.Flags.UseApplicationCommands)
    ...
    function setVocalPermissions() {
      const field6 = `${
        ...
        permissions.has(PermissionsBitField.Flags.UseVAD)
          ? `✅ ▸ Utiliser la détection de la voix\n`
          : ``
      } ${
        permissions.has(PermissionsBitField.Flags.PrioritySpeaker)
          ? `✅ ▸ Voix prioritaire\n`
          : ``
      } ${
        ...
        permissions.has(PermissionsBitField.Flags.DeafenMembers)
